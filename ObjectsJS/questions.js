...
push();
  ...
  textA(txt) {
    ...
    text(txt[1], 150 - 50, 245-50, 50);
    text(txt[0], 300 - 50, 245-50, 50);
    text(txt[2], 450 - 50, 245-50, 50);
  }

  textS(txt) {
    fill(255);
    text(txt[2], 150 - 50, 245-50, 50);
    text(txt[1], 300 - 50, 245-50, 50);
    text(txt[0], 450 - 50, 245-50, 50);
  }

  textM(txt) {
    fill(255);

    text(txt[0], 150 - 50, 245-50, 50);
    text(txt[2], 300 - 50, 245-50, 50);
    text(txt[1], 450 - 50, 245-50, 50);
  }
